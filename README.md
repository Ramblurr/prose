...
Below you will find the [Quick Start](#quick-start) section to get going. When
you are ready to dive deep, then check out:

- [Documentation index](doc/README.md)
  1. [Prose's reader](doc/reader.md) — learn the command language and how source
     becomes Clojure data.
  2. [Evaluation model](doc/evaluation.md) — run a document and work with its
     result.
  3. [Compiling documents](doc/compilation.md) — turn that result into HTML,
     Markdown, or another output format.
